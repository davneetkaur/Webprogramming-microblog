...
from app.forms import LoginForm, RegistrationForm, EditProfileForm, PostForm, ResetPasswordRequestForm, ResetPasswordRequestForm
...
def index():
    ...
    #followed_posts() returns a query. so all() is needed to execute the query and get the list of results.
